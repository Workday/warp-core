...
/**
 * Used in conjunction with <code>Schedule</code> to specify a one-time setup, regardless
 * of the number of invocations configured.
 *
 * Methods annotated with <code>BeforeClass</code> JUnit annotation are invoked once per class
